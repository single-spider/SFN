# Model Card: orientation_mesh_v2_symmetry_hybrid
...
- **Task:** `orientation`.
- **Checkpoint:** `models/orientation_mesh_v2_symmetry_hybrid.pt`.
- **Checkpoint SHA-256:** `5e8b548dfe2e1d7584bbc3077927994f2d76d9b66d17da585954421b0238de32`.
- **Size:** 1564073 bytes.
- **Checkpoint schema:** 1.
...
- **Selected epoch and global step:** 4 and 104.
- **Training samples and selected-epoch loss:** 3252 and 170.05938251201923.
...
|---|---|---:|---|---:|---|
| validation unseen | mesh_orthographic | 1054 | mean_abs_error_deg | 1.3567362428842504 | embedded checkpoint metadata |

Other scalar validation results: `exact_candidate_accuracy`=0.4240986717267552, `within_2_deg_accuracy`=0.905123339658444, `within_4_deg_accuracy`=0.9924098671726755.
